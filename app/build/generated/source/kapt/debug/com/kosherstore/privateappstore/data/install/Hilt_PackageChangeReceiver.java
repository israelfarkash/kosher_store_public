...
public abstract class Hilt_PackageChangeReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((PackageChangeReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectPackageChangeReceiver(UnsafeCasts.<PackageChangeReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
