...
public abstract class Hilt_DownloadBroadcastReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((DownloadBroadcastReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectDownloadBroadcastReceiver(UnsafeCasts.<DownloadBroadcastReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
