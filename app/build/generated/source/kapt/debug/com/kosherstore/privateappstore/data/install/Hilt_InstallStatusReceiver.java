...
public abstract class Hilt_InstallStatusReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((InstallStatusReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectInstallStatusReceiver(UnsafeCasts.<InstallStatusReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
