...
public abstract class Hilt_AppDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AppDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppDetailFragment_GeneratedInjector) this.generatedComponent()).injectAppDetailFragment(UnsafeCasts.<AppDetailFragment>unsafeCast(this));
    }
  }
